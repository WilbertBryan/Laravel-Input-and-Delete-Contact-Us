...
<section class="py-5">
        ...
        <main class="col-lg-6">
          <div class="ps-lg-3">
            ...
            <div class="row mb-4">
              ...
              <!-- col.// -->
              <form action="/product/{{ $data->id }}-{{ $data->name }}/addProduct" method="POST">
                @csrf
                <div class="col-12 mb-3">
                    ...
                    <input type="text" id="quantity" name="quantity" value ="1" class="form-control text-center border border-secondary" placeholder="1" aria-label="Example text with button addon" aria-describedby="button-addon1" />
  ...
  <script>
    ...
    var decreaseBtn = document.getElementById('button-addon1');
    var increaseBtn = document.getElementById('button-addon2');
